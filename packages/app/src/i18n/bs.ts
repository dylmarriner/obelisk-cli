export const dict = {
  ...
  "dialog.provider.obelisk.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.obelisk.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.obeliskGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Obelisk-u.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.obeliskZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.obeliskZen.visit.prefix": "Posjeti ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Obelisk-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Obelisk-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u obelisk.json",
  ...
  "dialog.server.description": "Promijeni na koji se Obelisk server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Obelisk u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Obelisk u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Obelisk u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Obelisk",
  "wsl.onboarding.obeliskReadyIn": "Obelisk je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.obeliskReady": "Obelisk je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Obelisk u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Obelisk mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Obelisk nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Obelisk.",
  ...
  "toast.update.description": "Nova verzija Obelisk-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Obelisk timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (obelisk.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Obelisk još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Obelisk server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Obelisk-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Obelisk izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Obelisk prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Obelisk-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Obelisk pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Obelisk-a.",
