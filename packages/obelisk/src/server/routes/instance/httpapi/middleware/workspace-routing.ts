...
>()("@obelisk/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@obelisk/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OBELISK_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OBELISK_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-obelisk-directory"] || process.cwd()
}
