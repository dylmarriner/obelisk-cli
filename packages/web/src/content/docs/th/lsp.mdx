...
description: Obelisk ทำงานร่วมกับเซิร์ฟเวอร์ LSP ของคุณ
---

Obelisk สามารถทำงานร่วมกับเซิร์ฟเวอร์ Language Server Protocol (LSP) เพื่อใช้ diagnostics เป็น feedback สำหรับ agent

---

## บิวท์อิน

Obelisk มาพร้อมกับเซิร์ฟเวอร์ LSP ในตัวหลายตัวสำหรับภาษายอดนิยม:
...
:::note
คุณสามารถปิดใช้งานการดาวน์โหลดเซิร์ฟเวอร์ LSP อัตโนมัติได้โดยตั้งค่าตัวแปรสภาพแวดล้อม `OBELISK_DISABLE_LSP_DOWNLOAD` เป็น `true`
:::
...
เมื่อเปิดใช้งาน LSP และ obelisk เปิดไฟล์ มันจะ:
...
คุณสามารถเปิดใช้งานและปรับแต่งเซิร์ฟเวอร์ LSP ผ่านส่วน `lsp` ในการกำหนดค่า obelisk
