...
import type { AssistantMessage as ObeliskAssistantMessage, Message } from "@obelisk-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@obelisk-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<ObeliskAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ObeliskAssistantMessage, "role"> &
  Partial<Pick<ObeliskAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@obelisk/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@obelisk/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@obelisk/ACPUsage") {}
