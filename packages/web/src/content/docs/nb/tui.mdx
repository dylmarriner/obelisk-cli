---
title: TUI
description: Bruke obelisk-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Obelisk gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Obelisk starter TUI for gjeldende katalog.
...
Når du bruker Obelisk TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Obelisk. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Obelisk. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `obelisk.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Obelisk venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `obelisk.default`.
