...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OBELISK_CALLER", () => {
    process.env["OBELISK_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OBELISK_CALLER", () => {
    process.env["OBELISK_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OBELISK_CALLER", () => {
    process.env["OBELISK_CALLER"] = "unknown"
