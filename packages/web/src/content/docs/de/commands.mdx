...
Erstellen Sie `.obelisk/commands/test.md`:

```md title=".obelisk/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Obelisk-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Obelisk [config](/docs/config):

```json title="obelisk.jsonc" {4-12}
{
...
- Global: `~/.config/obelisk/commands/`
- Pro Projekt: `.obelisk/commands/`

```markdown title="~/.config/obelisk/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".obelisk/commands/component.md"
---
...
```md title=".obelisk/commands/create-file.md"
---
...
```md title=".obelisk/commands/analyze-coverage.md"
---
...
```md title=".obelisk/commands/review-changes.md"
---
...
```md title=".obelisk/commands/review-component.md"
---
...
Obelisk enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
