      ...
      >
        ...
        <div>
          ...
          >
            ...
            <div style={{ color: c.white }}>obelisk.ai/data</div>
          </div>
        </div>
      </div>
    </AbsoluteFill>
