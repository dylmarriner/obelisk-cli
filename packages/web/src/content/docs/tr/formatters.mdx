...
description: obelisk dile özgü biçimlendiriciler kullanır.
---

obelisk, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

obelisk, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, obelisk bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

obelisk bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri obelisk yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
