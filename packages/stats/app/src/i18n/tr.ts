export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Obelisk Data",
  "app.description":
    "Obelisk Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Obelisk Data logosu",
  ...
  "header.githubAria": "GitHub'da Obelisk'a yıldız ver",
  "header.github": "GitHub",
  "header.tryObelisk": "Obelisk'u dene",
  ...
  "footer.homeAria": "Obelisk ana sayfası",
  ...
  "home.topModelsDescription": "Obelisk Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Obelisk Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Obelisk Data",
  "lab.description":
    "Obelisk Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Obelisk kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Obelisk'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Obelisk kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Obelisk token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Obelisk Data",
  "model.description":
    "{{model}} için Obelisk Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Obelisk Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Obelisk Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Obelisk Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Obelisk Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Obelisk Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Obelisk Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Obelisk Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Obelisk Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Obelisk Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Obelisk Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Obelisk Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Obelisk Go token hacmine göre yakındaki modeller.",
