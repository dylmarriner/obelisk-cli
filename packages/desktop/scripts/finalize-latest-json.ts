...
const releaseId = process.env.OBELISK_RELEASE
if (!releaseId) throw new Error("OBELISK_RELEASE is required")

const version = process.env.OBELISK_VERSION
if (!version) throw new Error("OBELISK_VERSION is required")
...
const macxTarGz = "obelisk-desktop-mac-x64.app.tar.gz"
const macaTarGz = "obelisk-desktop-mac-arm64.app.tar.gz"
