import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@obelisk-ai/sdk/v2"
import { SessionTurn } from "@obelisk-ai/session-ui/session-turn"
import { SessionReview } from "@obelisk-ai/session-ui/session-review"
import { DataProvider } from "@obelisk-ai/session-ui/context"
import { FileComponentProvider } from "@obelisk-ai/ui/context/file"
import { WorkerPoolProvider } from "@obelisk-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@obelisk-ai/ui/logo"
import { IconButton } from "@obelisk-ai/ui/icon-button"
import { ProviderIcon } from "@obelisk-ai/ui/provider-icon"
import { iife } from "@obelisk-ai/core/util/iife"
import { Binary } from "@obelisk-ai/core/util/binary"
import { NamedError } from "@obelisk-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@obelisk-ai/ui/tabs"
import { MessageNav } from "@obelisk-ai/session-ui/message-nav"
import { FileSSR } from "@obelisk-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@obelisk-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/obelisk-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Obelisk</Title>
              </Show>
              <Meta name="description" content="obelisk - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/obelisk"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
