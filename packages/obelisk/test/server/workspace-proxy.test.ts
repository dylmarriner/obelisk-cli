...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips obelisk-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-obelisk-directory"]).toBeUndefined()
      expect(forwarded["x-obelisk-workspace"]).toBeUndefined()
