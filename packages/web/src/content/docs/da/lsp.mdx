---
title: LSP-servere
description: Obelisk integreres med dine LSP-servere.
---

Obelisk kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Obelisk leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OBELISK_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og obelisk åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din obelisk-konfiguration.
