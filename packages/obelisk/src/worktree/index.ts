...
import { path } from "@obelisk-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@obelisk-ai/core/project"
...
import { WorktreeEvent } from "@obelisk-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `obelisk/${name}`
