import type { JsonSchema, LLMRequest, ProviderMetadata } from "@obelisk-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@obelisk-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @obelisk-ai/llm request objects from obelisk's session/AI SDK-shaped data.
  return LLM.request({
