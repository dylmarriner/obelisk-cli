export const dict = {
  ...
  "dialog.provider.obelisk.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.obelisk.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.obeliskGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Obelisk.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.obeliskZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.obeliskZen.visit.prefix": "Visite ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Obelisk.",
  ...
  "dialog.plugins.empty": "Plugins configurados em obelisk.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Obelisk este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Obelisk em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Obelisk em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Obelisk em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Obelisk",
  "wsl.onboarding.obeliskReadyIn": "O Obelisk está pronto em {{distro}}.",
  "wsl.onboarding.obeliskReady": "O Obelisk está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Obelisk em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Obelisk possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Obelisk não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Obelisk novamente.",
  ...
  "toast.update.description": "Uma nova versão do Obelisk ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Obelisk",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (obelisk.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Obelisk ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Obelisk dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Obelisk",
  ...
  "settings.general.row.appearance.description": "Personalize como o Obelisk aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Obelisk segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Obelisk é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Obelisk iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Obelisk.",
