...
import { MAX_STEPS_PROMPT } from "@obelisk-ai/core/session/runner/max-steps"
...
import { LLM } from "./llm"
import { Shell } from "@obelisk-ai/core/shell"
...
import { LLMEvent } from "@obelisk-ai/llm"
...
const STRUCTURED_OUTPUT_DESCRIPTION = `Return the final answer in the requested structured format.

Requirements:
- Call this tool exactly once at the end
- Input must be valid JSON matching the schema
- Finish research and tool use before calling it`

const STRUCTURED_OUTPUT_SYSTEM_PROMPT = `The user requested structured output. Use the StructuredOutput tool for the final response; do not answer in plain text.`
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/SessionPrompt") {}
