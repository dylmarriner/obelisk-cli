...
import { createOpencodeClient } from "@obelisk-ai/sdk/v2/client"
import { ServerAuth } from "@obelisk-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/cli/Daemon") {}
