...
- PR #10018: https://github.com/anomalyco/obelisk/pull/10018
- PR #12935: https://github.com/anomalyco/obelisk/pull/12935

## Do Not Translate (Locale Additions)

- `Obelisk` (preserve casing in prose; keep `obelisk` only in commands, package names, paths, or code)
- `Obelisk CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
