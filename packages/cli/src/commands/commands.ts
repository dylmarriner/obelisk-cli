...
declare const OBELISK_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof OBELISK_CLI_NAME === "string" ? OBELISK_CLI_NAME : "obelisk", {
  description: "OBELISK futuristic command line interface",
  commands: [
    Spec.make("api", {
