...
import compareVideo from "../../asset/lander/obelisk-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/obelisk-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="obelisk:auth" content={loggedin() ? "true" : "false"} />
