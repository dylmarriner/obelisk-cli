export const dict = {
  ...
  "dialog.provider.obelisk.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.obelisk.tagline": "Modèles optimisés et fiables",
  "dialog.provider.obeliskGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Obelisk.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.obeliskZen.visit.prefix": "Visitez ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Obelisk.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans obelisk.json",
  ...
  "dialog.server.description": "Changez le serveur Obelisk auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Obelisk dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Obelisk dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Obelisk dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Obelisk",
  "wsl.onboarding.obeliskReadyIn": "Obelisk est prêt dans {{distro}}.",
  "wsl.onboarding.obeliskReady": "Obelisk est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Obelisk dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Obelisk puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Obelisk n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Obelisk.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Obelisk ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Obelisk",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (obelisk.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Obelisk ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Obelisk inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Obelisk dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Obelisk",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Obelisk sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Obelisk suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Obelisk.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Obelisk",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Obelisk.",
