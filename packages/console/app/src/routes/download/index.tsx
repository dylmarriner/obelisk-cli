...
import desktopAppIcon from "../../asset/lander/obelisk-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://obelisk.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>obelisk.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g obelisk-ai")}>
                <code>
                  npm i -g <strong>obelisk-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g obelisk-ai")}>
                <code>
                  bun add -g <strong>obelisk-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/obelisk")}>
                <code>
                  brew install <strong>anomalyco/tap/obelisk</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S obelisk")}>
                <code>
                  paru -S <strong>obelisk</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask obelisk-desktop")}>
                <code>
                  brew install --cask <strong>obelisk-desktop</strong>
                </code>
                <CopyStatus />
              </button>
