...
const en = {
  "app.title": "AI Model Usage Rankings | Obelisk Data",
  "app.description":
    "Explore Obelisk Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Obelisk Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Obelisk on GitHub",
  "header.github": "GitHub",
  "header.tryObelisk": "Try Obelisk",
  ...
  "home.topModelsDescription": "Usage of models across Obelisk Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Obelisk Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Obelisk Data",
  "lab.description":
    "Compare {{lab}} models used in Obelisk Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Obelisk usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Obelisk",
  ...
  "lab.shareOfUsage": "{{share}} of recent Obelisk usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Obelisk Data",
  "model.description":
    "View {{model}} Obelisk Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Obelisk Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Obelisk Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Obelisk Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Obelisk Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Obelisk Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Obelisk Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Obelisk Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Obelisk Go token volume.",
