...
import defaultSoundPath from "@obelisk-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@obelisk-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@obelisk-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@obelisk-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@obelisk-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@obelisk-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "obelisk"
const DEFAULT_PACK_ID = "obelisk.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Obelisk Default",
  builtin: true,
  sounds: {
