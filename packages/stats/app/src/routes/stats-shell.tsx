import obeliskWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/obelisk",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "obelisk:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://obelisk.ai/">
            <strong>{i18n.t("header.tryObelisk")}</strong>
          </a>
          <button
...
function ObeliskMark() {
  return (
    <svg data-slot="obelisk-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://obelisk.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://obelisk.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@obelisk.ai", label: i18n.t("footer.contact") },
    { href: "https://obelisk.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/obelisk", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://obelisk.ai" aria-label={i18n.t("footer.homeAria")}>
          <ObeliskMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={obeliskWordmarkDark} alt="Obelisk" />
          <button
