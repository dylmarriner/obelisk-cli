...
import type { EffectDrizzleSqlite } from "@obelisk-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/ProjectDirectories") {}
