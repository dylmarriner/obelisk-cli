...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OBELISK.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/obelisk/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/obelisk (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/obelisk/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/obelisk/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OBELISK_DB|OBELISK_DB|OBELISK_DEV|Global\\.Path\\.data|data =" in packages/obelisk/src (115 matches)',
  },
] as const
