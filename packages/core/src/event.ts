...
import type { Data, Definition, Payload } from "@obelisk-ai/schema/event"
...
import { Durable } from "@obelisk-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@obelisk-ai/schema/event").ID
export type { Data, Definition, Payload } from "@obelisk-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/Event") {}
