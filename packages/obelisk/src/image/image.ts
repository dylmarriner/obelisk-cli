...
export class Service extends Context.Service<Service, Interface>()("@obelisk/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OBELISK_PHOTON_WASM_PATH?: string }).__OBELISK_PHOTON_WASM_PATH =
