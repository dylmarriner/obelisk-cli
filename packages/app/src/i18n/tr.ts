...
export const dict = {
  ...
  "dialog.provider.obelisk.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.obelisk.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.obeliskGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Obelisk tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Obelisk'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.obeliskZen.visit.prefix": "",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Obelisk'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Obelisk'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler obelisk.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Obelisk sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Obelisk kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Obelisk kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Obelisk güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Obelisk güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Obelisk'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Obelisk'u güncelle",
  "wsl.onboarding.obeliskReadyIn": "{{distro}} içinde Obelisk hazır.",
  "wsl.onboarding.obeliskReady": "Obelisk hazır.",
  "wsl.onboarding.installOpencodeIn": "Obelisk'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Obelisk'u kur",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Obelisk'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Obelisk bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Obelisk'u tekrar açın.",
  ...
  "toast.update.description": "Obelisk'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Obelisk ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (obelisk.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Obelisk henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Obelisk Masaüstü",
  ...
  "settings.desktop.wsl.description": "Obelisk sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Obelisk'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Obelisk'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Obelisk'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Obelisk'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Obelisk başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Obelisk'un en son sürümünü kullanıyorsunuz.",
