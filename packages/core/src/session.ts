...
import { ListAnchor } from "@obelisk-ai/schema/session"
...
import { SessionDurable } from "@obelisk-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/v2/Session") {}
