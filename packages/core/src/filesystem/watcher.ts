...
import { FileSystemWatcher } from "@obelisk-ai/schema/filesystem-watcher"
...
declare const OBELISK_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OBELISK_LIBC === "undefined" ? undefined : OBELISK_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OBELISK_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OBELISK_EXPERIMENTAL_FILEWATCHER) {
