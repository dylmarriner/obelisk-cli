...
import type { MessageV2 } from "obelisk/session/message-v2"
import type { Message } from "obelisk/session/message"
import type { Session } from "obelisk/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.obelisk_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.obelisk_name}>
