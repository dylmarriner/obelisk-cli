...
import { PermissionSaved } from "@obelisk-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/v2/PermissionSaved") {}
