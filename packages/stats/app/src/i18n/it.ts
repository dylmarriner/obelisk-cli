export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Obelisk Data",
  "app.description":
    "Esplora l'utilizzo di Obelisk Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Obelisk Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Obelisk su GitHub",
  "header.github": "GitHub",
  "header.tryObelisk": "Prova Obelisk",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Obelisk Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Obelisk Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Obelisk Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Obelisk Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Obelisk.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Obelisk",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Obelisk",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Obelisk negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Obelisk Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Obelisk Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Obelisk Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Obelisk Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Obelisk Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Obelisk Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Obelisk Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Obelisk Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Obelisk Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Obelisk Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Obelisk Go.",
  ...
  "model.geoDescription": "Token del modello Obelisk Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Obelisk Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Obelisk Go.",
