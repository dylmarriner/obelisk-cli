---
title: TUI
description: استخدام واجهة المستخدم TUI في Obelisk.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Obelisk واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Obelisk إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Obelisk في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Obelisk. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Obelisk. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `obelisk.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Obelisk بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `obelisk.default`.
