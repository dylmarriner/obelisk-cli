...
import type * as SDK from "@obelisk-ai/sdk/v2"
...
import { SessionShareTable } from "@obelisk-ai/core/share/sql"
...
const disabled = process.env["OBELISK_DISABLE_SHARE"] === "true" || process.env["OBELISK_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/ShareNext") {}
