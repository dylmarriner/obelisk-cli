...
import { EventSequenceTable, EventTable } from "@obelisk-ai/core/event/sql"
...
import { WorkspaceEvent } from "@obelisk-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OBELISK_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OBELISK_WORKSPACE_ID: config.id,
        OBELISK_EXPERIMENTAL_WORKSPACES: "true",
