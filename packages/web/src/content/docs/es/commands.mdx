...
Crear `.obelisk/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Obelisk o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Obelisk [config](/docs/config):
...
obelisk incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
