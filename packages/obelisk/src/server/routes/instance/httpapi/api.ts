...
import { makeApi } from "@obelisk-ai/protocol/api"
import { LocationMiddleware } from "@obelisk-ai/server/location"
import { SessionLocationMiddleware } from "@obelisk-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("obelisk-root")
...
export const InstanceHttpApi = HttpApi.make("obelisk-instance")
...
export const ObeliskHttpApi = HttpApi.make("obelisk")
