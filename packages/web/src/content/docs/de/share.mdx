---
title: Teilen
description: Teile Obelisk-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Obelisk-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Obelisk Folgendes:
...
Obelisk hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Obelisk den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`obelisk.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du obelisk in deiner Organisation einsetzt.
