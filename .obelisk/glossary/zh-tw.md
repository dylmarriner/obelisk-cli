...
- PR #13942: https://github.com/anomalyco/obelisk/pull/13942

## Do Not Translate (Locale Additions)

- `Obelisk` (preserve casing in prose; keep `obelisk` only when it is part of commands, package names, paths, or code)
- `Obelisk Zen`
- `Obelisk CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `obelisk` in prose when referring to the product name; use `Obelisk`
