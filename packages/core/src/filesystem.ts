...
import { Entry, FileSystem, FindInput, Match } from "@obelisk-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@obelisk-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/v2/FileSystem") {}
