export const dict = {
  ...
  "dialog.provider.obelisk.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.obelisk.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.obeliskGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Obelisk.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.obeliskZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.obeliskZen.visit.prefix": "Besøg ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Obelisk.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i obelisk.json",
  ...
  "dialog.server.description": "Skift hvilken Obelisk-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Obelisk i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Obelisk i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Obelisk i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Obelisk kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Obelisk kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Obelisk igen.",
  ...
  "toast.update.description": "En ny version af Obelisk ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Obelisk-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (obelisk.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Obelisk understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Obelisk-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Obelisk",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Obelisk ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Obelisk følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Obelisk er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Obelisk starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Obelisk.",
