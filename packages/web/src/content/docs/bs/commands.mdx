...
Kreiraj `.obelisk/commands/test.md`:
...
Možete dodati prilagođene komande kroz Obelisk konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Obelisk [config](/docs/config):
...
- Globalno: `~/.config/obelisk/commands/`
- Po projektu: `.obelisk/commands/`
...
Obelisk uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
