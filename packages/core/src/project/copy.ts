...
import { Event } from "@obelisk-ai/schema/project-directories"
import { ProjectCopy } from "@obelisk-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/ProjectCopy") {}
