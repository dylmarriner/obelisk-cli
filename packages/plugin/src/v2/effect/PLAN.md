...
- Effect plugins import `@obelisk-ai/plugin/v2/effect`, not `@obelisk-ai/core`.
- Public domain values use generated `@obelisk-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@obelisk-ai/plugin/v2/effect`.
