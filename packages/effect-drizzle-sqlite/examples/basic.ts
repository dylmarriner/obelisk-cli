...
class Database extends Context.Service<Database, DatabaseShape>()("@obelisk/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@obelisk/example/UserStore") {
