---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące obelisk.
---

Funkcja udostępniania obelisk umożliwia tworzenie publicznych linków do konwersacji obelisk, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, obelisk:
...
obelisk obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie obelisk korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `obelisk.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu obelisk w Twojej organizacji.
