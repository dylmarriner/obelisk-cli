...
export const TypeId: TypeId = "~@obelisk-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@obelisk-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@obelisk-ai/effect-sqlite-node/NodeSqliteClient")
