...
import type { Event, GlobalEvent, OpencodeClient } from "@obelisk-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@obelisk/RunStreamTransport") {}
