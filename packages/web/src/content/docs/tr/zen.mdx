---
title: Zen
description: obelisk tarafından sağlanan seçilmiş modeller listesi.
---
...
Obelisk Zen, Obelisk ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Obelisk'daki diğer sağlayıcılar gibi çalışır. Obelisk Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Obelisk kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Obelisk ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Obelisk Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Obelisk Zen, Obelisk'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Obelisk Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Obelisk Zen'i seçin ve API anahtarınızı yapıştırın.
...
Obelisk yapılandırmanızdaki [model id](/docs/config/#models) `obelisk/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `obelisk/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Obelisk'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Obelisk'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Obelisk'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Obelisk'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Obelisk'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Obelisk Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Obelisk ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
