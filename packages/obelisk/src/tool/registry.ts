...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@obelisk-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.obelisk || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/ToolRegistry") {}
