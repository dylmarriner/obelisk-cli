---
title: Özel Araçlar
description: LLM'un obelisk'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. obelisk'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.obelisk/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/obelisk/tools/` içine yerleştirerek.
