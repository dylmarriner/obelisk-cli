---
title: TUI
description: Brug af Obelisk-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Obelisk giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Obelisk starter TUI for den nuværende mappe.
...
Når du bruger Obelisk TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Obelisk. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Obelisk. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `obelisk.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Obelisk venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `obelisk.default`.
