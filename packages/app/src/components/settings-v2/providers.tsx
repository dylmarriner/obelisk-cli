...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "obelisk", key: "dialog.provider.obelisk.note" },
  { match: (id: string) => id === "obelisk-go", key: "dialog.provider.obeliskGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "obelisk" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "obelisk" || item.id === "obelisk-go"}>
