...
Practical reference for the current tool-migration state in `packages/obelisk`.
...
Tool tests should use the existing Effect helpers in `packages/obelisk/test/lib/effect.ts`:
