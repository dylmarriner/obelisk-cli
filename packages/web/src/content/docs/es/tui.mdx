---
title: TUI
description: Usando la interfaz de usuario del terminal Obelisk.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Obelisk proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Obelisk se inicia TUI para el directorio actual.
...
Cuando utilice Obelisk TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Obelisk. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Obelisk. _Alias_: `/quit`, `/q`
...
Esto es independiente de `obelisk.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Obelisk después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `obelisk.default`.
