 ...
 *   "@obelisk/ServerAuthConfig",
 *   {
 *     password: Config.string("OBELISK_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OBELISK_SERVER_USERNAME").pipe(Config.withDefault("obelisk")),
 *   },
 * ) {}
 *
