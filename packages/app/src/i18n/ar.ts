export const dict = {
  ...
  "dialog.provider.obelisk.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.obelisk.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.obeliskGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Obelisk",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Obelisk.",
  ...
  "provider.connect.obeliskZen.line1":
    "يمنحك Obelisk Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.obeliskZen.visit.prefix": "قم بزيارة ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Obelisk.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في obelisk.json",
  ...
  "dialog.server.description": "تبديل خادم Obelisk الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Obelisk في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Obelisk في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Obelisk في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Obelisk",
  "wsl.onboarding.obeliskReadyIn": "Obelisk جاهز في {{distro}}.",
  "wsl.onboarding.obeliskReady": "Obelisk جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Obelisk في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Obelisk من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Obelisk التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Obelisk.",
  ...
  "toast.update.description": "نسخة جديدة من Obelisk ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Obelisk",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (obelisk.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Obelisk لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Obelisk نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Obelisk داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Obelisk",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Obelisk على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Obelisk يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Obelisk.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Obelisk",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Obelisk.",
