...
description: Lag verktøy som LLM kan kalle inn Obelisk.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Obelisk sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.obelisk/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/obelisk/tools/`.
