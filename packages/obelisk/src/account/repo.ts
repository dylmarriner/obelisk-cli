...
import { AccountStateTable, AccountTable } from "@obelisk-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/AccountRepo") {}
