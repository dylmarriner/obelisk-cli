import type { Hooks, PluginInput } from "@obelisk-ai/plugin"
import type { Model } from "@obelisk-ai/sdk/v2"
import { InstallationVersion } from "@obelisk-ai/core/installation/version"
import { OauthCallbackPage } from "@obelisk-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Obelisk will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
