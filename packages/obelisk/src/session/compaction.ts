...
import { buildPrompt } from "@obelisk-ai/core/session/compaction"
import { SessionCompactionEvent } from "@obelisk-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/SessionCompaction") {}
