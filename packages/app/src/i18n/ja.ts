export const dict = {
  ...
  "dialog.provider.obelisk.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.obelisk.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.obeliskGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Obeliskが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Obeliskで{{provider}}モデルを使用します。",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.obeliskZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.obeliskZen.visit.prefix": " ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してObeliskで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Obeliskで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "obelisk.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するObeliskサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Obeliskを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のObeliskを確認中...",
  "wsl.onboarding.updatingOpencode": "Obeliskを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のObeliskを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のObeliskを更新してください。",
  "wsl.onboarding.updateOpencode": "Obeliskを更新",
  "wsl.onboarding.obeliskReadyIn": "{{distro}}内のObeliskの準備ができました。",
  "wsl.onboarding.obeliskReady": "Obeliskの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にObeliskをインストールしてください。",
  "wsl.onboarding.installOpencode": "Obeliskをインストール",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obeliskがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ObeliskでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Obeliskをもう一度開いてください。",
  ...
  "toast.update.description": "Obeliskの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをObeliskチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (obelisk.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ObeliskはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Obeliskには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でObeliskサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Obeliskの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのObeliskの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Obeliskがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Obeliskのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Obelisk の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Obelisk は最新バージョンです。",
