---
title: TUI
description: Korištenje korisničkog interfejsa Obelisk terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Obelisk pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Obelisk pokreće TUI za trenutni direktorij.
...
Kada koristite Obelisk TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Obelisk. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Obelisk. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `obelisk.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Obelisk čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `obelisk.default`.
