...
beforeAll(async () => {
  ...
  mock.module("@obelisk-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@obelisk-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@obelisk-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@obelisk-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
