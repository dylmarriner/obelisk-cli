...
export const dict = {
  ...
  "dialog.provider.obelisk.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.obelisk.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.obeliskGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Obelisk zu nutzen.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.obeliskZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.obeliskZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Obelisk zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Obelisk zu nutzen.",
  ...
  "dialog.plugins.empty": "In obelisk.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Obelisk-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.obelisk": "Obelisk",
  ...
  "wsl.onboarding.checkingOpencode": "Obelisk wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Obelisk in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Obelisk wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Obelisk in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Obelisk in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Obelisk aktualisieren",
  "wsl.onboarding.obeliskReadyIn": "Obelisk ist in {{distro}} bereit.",
  "wsl.onboarding.obeliskReady": "Obelisk ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Obelisk in {{distro}}.",
  "wsl.onboarding.installOpencode": "Obelisk installieren",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Obelisk einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Obelisk konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Obelisk erneut.",
  ...
  "toast.update.description": "Eine neue Version von Obelisk ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Obelisk-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (obelisk.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Obelisk unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Obelisk Desktop",
  ...
  "settings.desktop.wsl.description": "Obelisk-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Obelisk ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Obelisk auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Obelisk dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Obelisk anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Obelisk automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Obelisk.",
