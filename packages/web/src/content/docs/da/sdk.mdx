...
Brug den til at bygge integrasjoner og kontrollere obelisk programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `obelisk.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av obelisk, kan du oprete en klientforekomst for at koble til den:
