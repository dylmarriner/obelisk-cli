...
Desktop application and browser-based app issues, including `obelisk web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core obelisk server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Obelisk Zen, Obelisk Go, and billing issues.
