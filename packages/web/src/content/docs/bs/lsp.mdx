---
title: LSP serveri
description: Obelisk se integriše sa vašim LSP serverima.
---

Obelisk se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Obelisk dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `OBELISK_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i obelisk otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj obelisk konfiguraciji.
