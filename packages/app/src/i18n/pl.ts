export const dict = {
  ...
  "dialog.provider.obelisk.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.obelisk.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.obeliskGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Obelisk.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.obeliskZen.visit.prefix": "Odwiedź ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Obelisk.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w obelisk.json",
  ...
  "dialog.server.description": "Przełącz serwer Obelisk, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Obelisk w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Obelisk w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Obelisk w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Obelisk",
  "wsl.onboarding.obeliskReadyIn": "Obelisk jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.obeliskReady": "Obelisk jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Obelisk w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Obelisk będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Obelisk nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Obelisk.",
  ...
  "toast.update.description": "Nowa wersja Obelisk ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Obelisk",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (obelisk.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Obelisk nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Obelisk zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Obelisk wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Obelisk",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Obelisk na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Obelisk ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Obelisk.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Obelisk",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Obelisk.",
