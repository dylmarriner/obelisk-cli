export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | Obelisk Data",
  "app.description":
    "Досліджуйте використання Obelisk Go серед моделей ШІ, зокрема обсяг токенів, рейтинги, частку ринку, ціни токенів, вартість сеансу, частку кешу та географічні розрізи.",
  "app.unfurlAlt": "Словесний знак Obelisk Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку Obelisk на GitHub",
  "header.github": "GitHub",
  "header.tryObelisk": "Спробувати Obelisk",
  ...
  "footer.homeAria": "Головна Obelisk",
  ...
  "home.topModelsDescription": "Використання моделей в Obelisk Go.",
  ...
  "home.uniqueUsersDescription": "Щоденні унікальні користувачі Obelisk Go за моделлю.",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | Obelisk Data",
  "lab.description":
    "Порівняйте моделі {{lab}}, які використовуються в Obelisk Go, зокрема використання токенів, рейтинги моделей, контекстні вікна, дати релізів, вартість і дані конкретних моделей.",
  "lab.loadingTitle": "Лабораторія моделей",
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання Obelisk.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в Obelisk",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання Obelisk",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів Obelisk за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | Obelisk Data",
  "model.description":
    "Перегляньте дані використання {{model}} в Obelisk Go, зокрема обсяг токенів, тижневий ранг, мікс токенів, вартість, частку кешу, сеанси, географічні розрізи та схожі моделі.",
  ...
  "model.catalogFallback":
    "Факти моделі зі спільного індексу моделей. Використання Obelisk Go з'явиться, коли ця модель матиме активність.",
  "model.unranked": "Без рейтингу у використанні Obelisk Go за минулий тиждень",
  "model.ranked": "Ранг #{{rank}} у використанні Obelisk Go за минулий тиждень",
  ...
  "model.noCurrentUsage": "Немає використання Obelisk Go в поточному вікні даних.",
  ...
  "model.release": "Реліз",
  "model.inputs": "Входи",
  "model.overviewDescription": "Нещодавні токени Obelisk Go, унікальні користувачі та ринкова позиція.",
  "model.noSummaryTitle": "Немає підсумку використання",
  "model.noSummaryDescription": "Ця модель ще не має рядків використання Obelisk Go.",
  "model.tokens": "Токени",
  ...
  "model.usageDescription": "Щоденний обсяг токенів Obelisk Go за нещодавнє двомісячне вікно.",
  ...
  "model.usersDescription": "Щоденні унікальні користувачі Obelisk Go за нещодавнє двомісячне вікно.",
  ...
  "model.efficiencyDescription": "Вартість, поведінка кешу та середня форма сеансу Obelisk Go.",
  ...
  "model.geoDescription": "Токени моделі Obelisk Go, використані за країнами.",
  "model.noGeoTitle": "Немає геоданих",
  "model.noGeoDescription": "Жодні географічні рядки Obelisk Go не відповідали цій моделі.",
  "model.worldMap": "Карта світу використання токенів моделі за країнами",
  "model.peersDescription": "Близькі моделі за нещодавнім обсягом токенів Obelisk Go.",
