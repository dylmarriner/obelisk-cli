...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/obelisk.git")).toEqual({ owner: "sst", repo: "obelisk" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/obelisk")).toEqual({ owner: "sst", repo: "obelisk" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/obelisk.git")).toEqual({ owner: "sst", repo: "obelisk" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/obelisk")).toEqual({ owner: "sst", repo: "obelisk" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/obelisk.git")).toEqual({ owner: "sst", repo: "obelisk" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/obelisk")).toEqual({ owner: "sst", repo: "obelisk" })
})
