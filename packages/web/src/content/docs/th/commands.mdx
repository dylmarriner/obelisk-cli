...
สร้าง `.obelisk/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Obelisk:
...
- ระดับผู้ใช้ (Global): `~/.config/obelisk/commands/`
- ระดับโปรเจ็กต์: `.obelisk/commands/`
...
Obelisk มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
