...
export class Service extends Context.Service<Service, Interface>()("@obelisk/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.OBELISK_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
