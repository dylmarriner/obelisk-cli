...
import { ProjectDirectoryTable, ProjectTable } from "@obelisk-ai/core/project/sql"
import { ProjectDirectories } from "@obelisk-ai/core/project/directories"
...
import { which } from "@obelisk-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.OBELISK_FAKE_VCS)
