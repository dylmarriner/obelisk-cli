import type { PluginContext } from "@obelisk-ai/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@obelisk-ai/sdk/v2/types"
