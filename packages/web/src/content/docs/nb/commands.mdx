...
Opprett `.obelisk/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Obelisk-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Obelisk [config](/docs/config):
...
Obelisk inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
