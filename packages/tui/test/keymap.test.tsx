...
import { getOpencodeModeStack, OBELISK_BASE_MODE, OpencodeKeymapProvider, registerOpencodeKeymap } from "../src/keymap"
...
test("mode-less bindings stay active when obelisk mode changes", async () => {
