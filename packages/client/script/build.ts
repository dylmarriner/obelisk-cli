...
import { compile, emitEffectImported, emitPromise, write } from "@obelisk-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "ObeliskEventEncoded",
              import: 'import type { ObeliskEventEncoded } from "@obelisk-ai/protocol/groups/event"',
            },
          },
        }),
