...
import { AbsolutePath, type DeepMutable } from "@obelisk-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".obelisk", "plans", "*.md")]: "allow",
