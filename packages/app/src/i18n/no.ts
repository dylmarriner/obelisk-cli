...
export const dict = {
  ...
  "dialog.provider.obelisk.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.obelisk.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.obeliskGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Obelisk.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.obeliskZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.obeliskZen.visit.prefix": "Besøk ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Obelisk.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i obelisk.json",
  ...
  "dialog.server.description": "Bytt hvilken Obelisk-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Obelisk ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Obelisk-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (obelisk.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Obelisk ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Obelisk-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Obelisk",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Obelisk ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Obelisk skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Obelisk er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Obelisk starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Obelisk.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Obelisk i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Obelisk i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Obelisk i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Obelisk",
  "wsl.onboarding.obeliskReadyIn": "Obelisk er klar i {{distro}}.",
  "wsl.onboarding.obeliskReady": "Obelisk er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Obelisk i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Obelisk kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Obelisk kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Obelisk på nytt.",
