---
title: Paylasim
description: obelisk konusmalarini genel baglantilarla paylasin.
---

obelisk'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda obelisk:
...
obelisk, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak obelisk manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `obelisk.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda obelisk kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
