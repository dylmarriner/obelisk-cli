...
- PR #15835: https://github.com/anomalyco/obelisk/pull/15835

## Do Not Translate (Locale Additions)

- `Obelisk` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `obelisk` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Obelisk` in prose, `obelisk` only for exact technical identifiers
...
- Avoid changing `obelisk` to `Obelisk` inside commands, URLs, package names, or code literals
