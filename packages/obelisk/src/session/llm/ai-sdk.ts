import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@obelisk-ai/llm"
...
// Move this extraction into @obelisk-ai/llm when Copilot is handled by the native runtime.
