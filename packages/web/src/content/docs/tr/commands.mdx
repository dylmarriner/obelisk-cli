...
`.obelisk/commands/test.md` oluştur:
...
obelisk işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

obelisk [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/obelisk/commands/`
- Proje başına: `.obelisk/commands/`
...
obelisk, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
