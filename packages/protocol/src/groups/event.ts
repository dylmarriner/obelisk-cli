...
import { EventManifest } from "@obelisk-ai/schema/event-manifest"
import { Location } from "@obelisk-ai/schema/location"
import type { Definition } from "@obelisk-ai/schema/event"
...
export const ObeliskEvent = event.schema
export type ObeliskEvent = typeof ObeliskEvent.Type
export type ObeliskEventEncoded = typeof ObeliskEvent.Encoded
