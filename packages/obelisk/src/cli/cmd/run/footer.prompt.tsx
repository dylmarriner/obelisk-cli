...
import { normalizePromptContent } from "@obelisk-ai/tui/editor"
...
import { OBELISK_BASE_MODE, useBindings } from "@obelisk-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Obelisk" } satisfies SlashOption,
    ]
