// Shared type vocabulary for the direct interactive mode (`obelisk --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@obelisk-ai/sdk/v2"
