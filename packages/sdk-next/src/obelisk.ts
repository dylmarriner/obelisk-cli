import { Obelisk } from "@obelisk-ai/client/effect"
...
import { createEmbeddedRoutes } from "@obelisk-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Obelisk.create")(function* () {
  ...
  const client = yield* Obelisk.make({ baseUrl: "http://obelisk.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@obelisk-ai/sdk-next/Obelisk") {}
