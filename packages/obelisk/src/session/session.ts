...
import { Slug } from "@obelisk-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@obelisk-ai/llm"
...
import { locationServiceMapLayer } from "@obelisk-ai/core/location-services"
...
import { PartTable, SessionTable } from "@obelisk-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@obelisk-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".obelisk", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/Session") {}
