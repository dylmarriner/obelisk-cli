...
Puoi aggiungere comandi personalizzati tramite la config di Obelisk o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Obelisk:
...
- Globale: `~/.config/obelisk/commands/`
- Per progetto: `.obelisk/commands/`
...
obelisk include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
