...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@obelisk/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@obelisk/ACPDirectory") {}
