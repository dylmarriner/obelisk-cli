...
const GLOBAL_STORAGE = "obelisk.global.dat"
const WINDOW_STORAGE = "obelisk.window"
const LOCAL_PREFIX = "obelisk."
...
function workspaceStorage(dir: string) {
  ...
  return `obelisk.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `obelisk.draft.${head}.${sum}.dat`
}
