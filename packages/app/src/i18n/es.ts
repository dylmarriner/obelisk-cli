export const dict = {
  ...
  "dialog.provider.obelisk.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.obelisk.tagline": "Modelos optimizados y fiables",
  "dialog.provider.obeliskGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Obelisk.",
  ...
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.obeliskZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.obeliskZen.visit.prefix": "Visita ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Obelisk.",
  ...
  "dialog.plugins.empty": "Plugins configurados en obelisk.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Obelisk se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Obelisk en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Obelisk en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Obelisk en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Obelisk",
  "wsl.onboarding.obeliskReadyIn": "Obelisk está listo en {{distro}}.",
  "wsl.onboarding.obeliskReady": "Obelisk está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Obelisk en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Obelisk pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Obelisk no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Obelisk.",
  ...
  "toast.update.description": "Una nueva versión de Obelisk ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Obelisk",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (obelisk.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Obelisk no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Obelisk dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Obelisk",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Obelisk en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Obelisk sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Obelisk.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Obelisk",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Obelisk.",
