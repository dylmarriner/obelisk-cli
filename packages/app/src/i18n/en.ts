export const dict = {
  ...
  "dialog.provider.obelisk.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.obelisk.tagline": "Reliable optimized models",
  "dialog.provider.obeliskGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Obelisk",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Obelisk.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.obeliskZen.line1":
    "Obelisk Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.obeliskZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.obeliskZen.visit.prefix": "Visit ",
  "provider.connect.obeliskZen.visit.link": "obelisk.ai/zen",
  "provider.connect.obeliskZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Obelisk.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Obelisk.",
  ...
  "dialog.plugins.empty": "Plugins configured in obelisk.json",
  ...
  "dialog.server.description": "Switch which Obelisk server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Obelisk...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Obelisk in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Obelisk...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Obelisk in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Obelisk in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Obelisk",
  "wsl.onboarding.obeliskReadyIn": "Obelisk is ready in {{distro}}.",
  "wsl.onboarding.obeliskReady": "Obelisk is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Obelisk in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Obelisk",
  ...
  "wsl.onboarding.distroStatus.obeliskMissing": "Obelisk not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Obelisk can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Obelisk could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Obelisk.",
  ...
  "toast.update.description": "A new version of Obelisk ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Obelisk team",
  ...
  "error.chain.checkConfig": "Check your config (obelisk.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Obelisk does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Obelisk includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Obelisk server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Obelisk",
  ...
  "settings.general.row.appearance.description": "Customise how Obelisk looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Obelisk follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Obelisk is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Obelisk launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Obelisk.",
