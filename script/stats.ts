...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/obelisk/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/obelisk...\n")
...
console.log("Fetching npm all-time downloads for obelisk-ai...\n")
const npmDownloads = await fetchNpmDownloads("obelisk-ai")
