...
//
// The saved variant persists across sessions in ~/.local/state/obelisk/model.json
...
class Service extends Context.Service<Service, VariantService>()("@obelisk/RunVariant") {}
