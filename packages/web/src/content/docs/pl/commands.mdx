...
Utwórz `.obelisk/commands/test.md`:
...
Możesz zdefiniować polecenia w `obelisk.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji obelisk:
...
- Globalnie: `~/.config/obelisk/commands/`
- Na projekt: `.obelisk/commands/`
...
obelisk zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
