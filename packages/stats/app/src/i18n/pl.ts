export const dict = {
  "app.title": "Rankingi użycia modeli AI | Obelisk Data",
  "app.description":
    "Przeglądaj użycie Obelisk Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Obelisk Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Obelisk na GitHub",
  "header.github": "GitHub",
  "header.tryObelisk": "Wypróbuj Obelisk",
  ...
  "footer.homeAria": "Strona główna Obelisk",
  ...
  "home.topModelsDescription": "Użycie modeli w Obelisk Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Obelisk Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Obelisk Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Obelisk Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Obelisk.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Obelisk",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Obelisk",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Obelisk z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Obelisk Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Obelisk Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Obelisk Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Obelisk Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Obelisk Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Obelisk Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Obelisk Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Obelisk Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Obelisk Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Obelisk Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Obelisk Go.",
  ...
  "model.geoDescription": "Tokeny modelu Obelisk Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Obelisk Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Obelisk Go.",
