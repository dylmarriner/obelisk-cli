...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@obelisk-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@obelisk/v2/ToolRegistry") {}
