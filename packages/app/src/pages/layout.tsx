...
import { getFilename } from "@obelisk-ai/core/util/path"
import { Session } from "@obelisk-ai/sdk/v2/client"
...
import { toaster } from "@obelisk-ai/ui/toast"
...
import { retry } from "@obelisk-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@obelisk-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://obelisk.ai/desktop-feedback")}
      renderPanel={() =>
